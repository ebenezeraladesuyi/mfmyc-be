...
const registerMember = async (req, res) => {
    try {
        const { firstName, surname, email, phoneNumber, educationalQualification, address, emergencyContactName, emergencyContactRelationship, emergencyContactNumber, } = req.body;
